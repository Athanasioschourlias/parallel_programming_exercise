...
with open(os.path.join(os.getcwd(), "wikipedia", "wikipedia_urls" + ".txt"), 'r') as f:
    file_content = f.read()
...
def pos_neg_words():
    with open(os.path.join(os.getcwd(), "words", "positive_words" + ".txt"), 'r') as fp:
        file_pos_content = fp.read()
        lpositive_words = file_pos_content.split('\n')

    with open(os.path.join(os.getcwd(), "words", "negative_words" + ".txt"), 'r') as fn:
