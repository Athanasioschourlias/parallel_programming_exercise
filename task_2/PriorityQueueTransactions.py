...
def main():
    ...
    q10 = queue.PriorityQueue()
    q20 = queue.PriorityQueue()
    q40 = queue.PriorityQueue()
    ...
    for j in range(totalTransactionsBToA1):
        q10.put((totalTransactionsAToB1+j,j))
    for j in range(totalTransactionsAToB2):
        q20.put((totalTransactionsAToB1+totalTransactionsBToA1+j,j))

    for j in range(totalTransactionsBToA2):
        q40.put((totalTransactionsAToB1+totalTransactionsBToA1+totalTransactionsAToB2+j,j))
